  ...
  foreach(line ${RUSTC_VERSION_OUTPUT})
    ...
    if(line MATCHES "^([^:]+): (.*)$")
      ...
      if(KEY STREQUAL "release")
        ...
        set(RUST_MSRV "1.85.0")
        if(RUST_VERSION MATCHES "^[0-9]+(\\.[0-9]+)?(\\.[0-9]+)?" AND RUST_VERSION VERSION_LESS RUST_MSRV)
            message(FATAL_ERROR "Unsupported Rust compiler version: ${RUST_VERSION}. Minimum supported version is ${RUST_MSRV}\nMake sure you have either 'rustup' installed, or have 'rustc' updated to the required version. (up to 'rustup 1.75.0')")
        endif()
